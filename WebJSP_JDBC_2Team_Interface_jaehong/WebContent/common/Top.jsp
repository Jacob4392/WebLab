...
<header id="header" class="fixed-top">
	<div class="container d-flex">
		...
		<nav class="nav-menu d-none d-lg-block">
			<ul>
				<li class="active"><a href="<%=request.getContextPath()%>/main.do">Main</a></li>
				<c:if test="${empty sessionScope.userid}">
					<li><a href="<%=request.getContextPath()%>/loginPage.do">Login</a></li>
					<li><a href="<%=request.getContextPath()%>/SignUpPage.do">Sign Up</a></li>
				</c:if>
