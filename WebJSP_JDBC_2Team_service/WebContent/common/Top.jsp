...
<header id="header" class="fixed-top">
	<div class="container d-flex">
		...
		<div class="logo mr-auto">
			<h1 class="text-light">
				<a href="Ex02_JDBC_Main.jsp"><span>Team2_&nbsp;MVC</span></a>
			</h1>
		</div>
		...
		<nav class="nav-menu d-none d-lg-block">
			<ul>
				...
				<c:if test="${sessionScope.userid == 'admin'}">
					<li><a href="ShowEmpList.member">사원 관리</a></li>
				</c:if>
				<li class="drop-down"><a href="">DROP-DOWN</a>
					<ul>
						<c:if test="${sessionScope.userid == 'admin'}">
						<li><a href="ChartEmp.member">사원 차트 보기</a></li>
						<li><a href="Joinform.member">신규 사원 등록</a></li>
						</c:if>
						<li><a href="#">---</a></li>
