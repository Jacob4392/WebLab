...
public class BoardAddAction implements Action{
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			//System.out.println("setBoard_file:" + multi.getFilesystemName((String)multi
			//			.getFileNames().nextElement())); //null
			//System.out.println("setBoard_file:" + (String)multi.getFileNames().nextElement()); //BOARD_FILE
