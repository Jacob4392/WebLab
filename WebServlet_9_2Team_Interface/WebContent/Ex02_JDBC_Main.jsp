						...
						<c:choose>
							<c:when test="${not empty sessionScope.userid}">
								...
								<c:if test="${sessionScope.userid == 'admin' }">
									...
									<a class="btn-get-started scrollto" href="MemberList.member">Member List</a>
									<a class="btn-get-started scrollto" href="Logout.member">Log out</a>
								</c:if>
								<c:if test="${sessionScope.userid != 'admin' }">
									<a class="btn-get-started scrollto" href="boardlist.do">Board List</a>
									<a class="btn-get-started scrollto" href="Logout.member">Log out</a>
								</c:if>
