						...
						<div class="table-responsive">
							<table class="table">
								...
								<tbody>
									...
									<tr>
										<td>${status.count}</td>
										<td><a href='MemberDetailServlet?id=${col.id}'>${col.id}</a></td>
										<td>${col.ip}</td>
										<td><a href="MemberDeleteServlet?id=${col.id}">Delete</a></td>
										<td><a href="MemberEditServlet?id=${col.id}">Update</a></td>
									</tr>
									</c:forEach>
								</tbody>
							</table>
